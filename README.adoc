...
And in *Sonar* you need to enable webhooks in `Administration > Configuration > General Settings > Webhooks.` using *http://localhost:8080/sonarqube-webhook/* as value:
