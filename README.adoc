...
* Pipeline model api (http://updates.jenkins-ci.org/download/plugins/pipeline-model-definition/1.2.2/pipeline-model-definition.hpi[v1.2.2 or above^]) [Note that it already comes with Jenkins, you may have to upgrade]
* Pipeline declarative (http://updates.jenkins-ci.org/download/plugins/pipeline-model-definition/1.2.2/pipeline-model-definition.hpi[v1.2.2 or above^]) [Note that it already comes with Jenkins, you may have to upgrade]
