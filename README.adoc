...
This pipeline have an https://github.com/rmpestano/tdc-pipeline/blob/master/vars/notify.groovy[example of shared library^]. Configure `https://github.com/rmpestano/tdc-pipeline` as a shared lib on your Jenkins like in image below:
